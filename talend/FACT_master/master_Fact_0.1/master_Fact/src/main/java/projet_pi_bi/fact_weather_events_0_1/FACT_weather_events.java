...
package projet_pi_bi.fact_weather_events_0_1;
...
/**
 * Job: FACT_weather_events Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class FACT_weather_events implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "FACT_weather_events";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				FACT_weather_events.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(FACT_weather_events.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_FACT_weather_events = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_FACT_weather_events = new byte[0];
			    ...
			    public String Total_Rainfall;

				public String getTotal_Rainfall () {
					return this.Total_Rainfall;
				}
				
			    public String Max_win_speed;

				public String getMax_win_speed () {
					return this.Max_win_speed;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_FACT_weather_events.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_FACT_weather_events.length == 0) {
   					commonByteArray_PROJET_PI_BI_FACT_weather_events = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_FACT_weather_events = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_FACT_weather_events, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_FACT_weather_events, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_FACT_weather_events, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_FACT_weather_events, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_FACT_weather_events) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Total_Rainfall = readString(dis);
					
					this.Max_win_speed = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Total_Rainfall,dos);
					
					// String
				
						writeString(this.Max_win_speed,dos);
    ...
    public String toString() {
		...
		sb.append(",Total_Rainfall="+Total_Rainfall);
		sb.append(",Max_win_speed="+Max_win_speed);
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+Z0t0zjRcAYRlzqqUplA8XRJ4kXz+6BCxhPwaOXqwlXu2Yv8vUQ=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Fact_Weather_Events";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Fact_Weather_Events";
}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1 + "]([Date_FK] INT  not null ,[Location_FK] INT  not null ,[temp_max_mean] VARCHAR(17)  ,[Total_Rainfall] VARCHAR(4)  ,[Max_win_speed] VARCHAR(4)  ,[weather_score] INT ,[Latitude] VARCHAR(11)  ,[Longitude] VARCHAR(12)  )");
                                    }
                                }
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Date_FK],[Location_FK],[temp_max_mean],[Total_Rainfall],[Max_win_speed],[weather_score],[Latitude],[Longitude]) VALUES (?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Jq7K3z3aJc+3eR9l1NuzP/+KBTuwkZF5vmeuszNdnmSnQZb6zFA=");
		    ...
		    String dbquery_tDBInput_1 = "select dbo.events_prediction_dataset.event_id,dbo.events_prediction_dataset.event,dbo.events_prediction_dataset.Code_li"
...
+".events_prediction_dataset.weather_score,dbo.events_prediction_dataset.good_weather,dbo.events_prediction_dataset.date_c"
+"ode \nfrom youth_leadership_and_outdoor_education.dbo.events_prediction_dataset";
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.event_id = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.event_id = tmpContent_tDBInput_1;
                }
            } else {
                row1.event_id = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.event = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.event = tmpContent_tDBInput_1;
                }
            } else {
                row1.event = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.season = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.season = tmpContent_tDBInput_1;
                }
            } else {
                row1.season = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.event_duration_days = null;
							} else {
		                          
            row1.event_duration_days = rs_tDBInput_1.getInt(9);
            if(rs_tDBInput_1.wasNull()){
                    row1.event_duration_days = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.temp_max_mean = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.temp_max_mean = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.temp_max_mean = tmpContent_tDBInput_1;
                }
            } else {
                row1.temp_max_mean = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(11).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.rain_total = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.rain_total = tmpContent_tDBInput_1;
                }
            } else {
                row1.rain_total = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(12).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.wind_max = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.wind_max = tmpContent_tDBInput_1;
                }
            } else {
                row1.wind_max = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.weather_score = null;
							} else {
		                          
            row1.weather_score = rs_tDBInput_1.getInt(13);
            if(rs_tDBInput_1.wasNull()){
                    row1.weather_score = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.good_weather = null;
							} else {
	                         		
            row1.good_weather = rs_tDBInput_1.getBoolean(14);
            if(rs_tDBInput_1.wasNull()){
                    row1.good_weather = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(15).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.date_code = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.date_code = tmpContent_tDBInput_1;
                }
            } else {
                row1.date_code = null;
            }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.full_date = (row1.date_code == null || row1.date_code.trim().isEmpty()) ? null : TalendDate.parseDateLocale("EEE MMM dd HH:mm:ss zzz yyyy", row1.date_code, "EN") == null ? null : new java.util.Date((row1.date_code == null || row1.date_code.trim().isEmpty()) ? null : TalendDate.parseDateLocale("EEE MMM dd HH:mm:ss zzz yyyy", row1.date_code, "EN").getTime());
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.Code_lieu = row1.Code_lieu ;
								  ...
								  if(!tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.Code_lieu = '" + row3HashKey.Code_lieu + "'");
								} // G 071
...
out1_tmp.Location_FK = row3.id_gouvernorat ;
out1_tmp.temp_max_mean = row1.temp_max_mean ;
out1_tmp.Total_Rainfall = row1.rain_total ;
out1_tmp.Max_win_speed = row1.wind_max ;
out1_tmp.weather_score = row1.weather_score ;
out1_tmp.Latitude = row1.lat ;
out1_tmp.Longitude = row1.lon ;
out1 = out1_tmp;
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    ...
                    pstmt_tDBOutput_1.setInt(2, out1.Location_FK);

                    if(out1.temp_max_mean == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, out1.temp_max_mean);
}

                    if(out1.Total_Rainfall == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, out1.Total_Rainfall);
}

                    if(out1.Max_win_speed == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, out1.Max_win_speed);
}

                    if(out1.weather_score == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(6, out1.weather_score);
}

                    if(out1.Latitude == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, out1.Latitude);
}

                    if(out1.Longitude == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, out1.Longitude);
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2o5cW3JzC6xewUl1rEr0/QrtolWWBsRyZy6nhOBFTN6C3915sUQ=");
		    ...
		    String dbquery_tDBInput_2 = "select dbo.dim_date.date_id,dbo.dim_date.full_date,dbo.dim_date.jour_nom,dbo.dim_date.mois_nom,dbo.dim_date.annee,dbo.d"
+"im_date.trimestre,dbo.dim_date.saison \nfrom scout_DW.dbo.dim_date";
            ...
            row2.date_id = rs_tDBInput_2.getInt(1);
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.jour_nom = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.jour_nom = tmpContent_tDBInput_2;
                }
            } else {
                row2.jour_nom = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.mois_nom = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.mois_nom = tmpContent_tDBInput_2;
                }
            } else {
                row2.mois_nom = null;
            }
            ...
            row2.annee = rs_tDBInput_2.getInt(5);
            if(rs_tDBInput_2.wasNull()){
                    row2.annee = null;
            }
		                    }
            ...
            row2.trimestre = rs_tDBInput_2.getInt(6);
            if(rs_tDBInput_2.wasNull()){
                    row2.trimestre = null;
            }
		                    }
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:EG3FrF/0e1VrQuZPo5chhAzi2cF8PRFcdOmGH40FkUYwU3l9P4M=");
		    ...
		    String dbquery_tDBInput_3 = "select dbo.dim_location.Code_lieu,dbo.dim_location.Gouvernorat,dbo.dim_location.id_gouvernorat \nfrom scout_DW.dbo.dim_l"
+"ocation";
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.Gouvernorat = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.Gouvernorat = tmpContent_tDBInput_3;
                }
            } else {
                row3.Gouvernorat = null;
            }
							...
							if(colQtyInRs_tDBInput_3 < 3) {
								row3.id_gouvernorat = 0;
							} else {
		                          
            row3.id_gouvernorat = rs_tDBInput_3.getInt(3);
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.Code_lieu = row3.Code_lieu;
				
				row3_HashRow.Gouvernorat = row3.Gouvernorat;
				
				row3_HashRow.id_gouvernorat = row3.id_gouvernorat;
 ...
 */
    ...
    public static void main(String[] args){
        final FACT_weather_events FACT_weather_eventsClass = new FACT_weather_events();

        int exitCode = FACT_weather_eventsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = FACT_weather_events.class.getClassLoader().getResourceAsStream("projet_pi_bi/fact_weather_events_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = FACT_weather_events.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : FACT_weather_events");
        }
...
/************************************************************************************************
 *     141612 characters generated by Talend Open Studio for Data Integration 

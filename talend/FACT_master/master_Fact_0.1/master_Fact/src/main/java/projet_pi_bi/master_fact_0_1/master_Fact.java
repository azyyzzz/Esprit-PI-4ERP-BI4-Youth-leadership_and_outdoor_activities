...
package projet_pi_bi.master_fact_0_1;
...
/**
 * Job: master_Fact Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class master_Fact implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "master_Fact";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(master_Fact.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_master_Fact = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_master_Fact = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_master_Fact) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		projet_pi_bi.fact_activities_0_1.Fact_Activities childJob_tRunJob_1 = new projet_pi_bi.fact_activities_0_1.Fact_Activities();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		projet_pi_bi.fact_camps_0_1.FACT_Camps childJob_tRunJob_2 = new projet_pi_bi.fact_camps_0_1.FACT_Camps();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		projet_pi_bi.fact_sponsors_0_1.Fact_sponsors childJob_tRunJob_3 = new projet_pi_bi.fact_sponsors_0_1.Fact_sponsors();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		projet_pi_bi.fact_weather_events_0_1.FACT_weather_events childJob_tRunJob_4 = new projet_pi_bi.fact_weather_events_0_1.FACT_weather_events();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final master_Fact master_FactClass = new master_Fact();

        int exitCode = master_FactClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = master_Fact.class.getClassLoader().getResourceAsStream("projet_pi_bi/master_fact_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = master_Fact.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : master_Fact");
        }
...
/************************************************************************************************
 *     52741 characters generated by Talend Open Studio for Data Integration 

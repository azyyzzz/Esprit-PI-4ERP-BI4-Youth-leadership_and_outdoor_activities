...
package projet_pi_bi.fact_sponsors_0_1;
...
/**
 * Job: Fact_sponsors Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Fact_sponsors implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Fact_sponsors";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Fact_sponsors.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Fact_sponsors.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_Fact_sponsors = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_Fact_sponsors = new byte[0];

	
			    public int Location_FK;

				public int getLocation_FK () {
					return this.Location_FK;
				}
			    ...
			    public int Sponsor_FK;

				public int getSponsor_FK () {
					return this.Sponsor_FK;
				}
				
			    public Integer promised_amount_TND;

				public Integer getPromised_amount_TND () {
					return this.promised_amount_TND;
				}
				
			    public Integer Received_amount_TND;

				public Integer getReceived_amount_TND () {
					return this.Received_amount_TND;
				}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Fact_sponsors) {

        	try {

        		int length = 0;
		
			        this.Location_FK = dis.readInt();
					
			        this.Date_FK = dis.readInt();
					
			        this.Unit_FK = dis.readInt();
					
			        this.Sponsor_FK = dis.readInt();
					
						this.promised_amount_TND = readInteger(dis);
					
						this.Received_amount_TND = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.Sponsor_FK);
					
					// Integer
				
						writeInteger(this.promised_amount_TND,dos);
					
					// Integer
				
						writeInteger(this.Received_amount_TND,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("Location_FK="+String.valueOf(Location_FK));
		sb.append(",Date_FK="+String.valueOf(Date_FK));
		sb.append(",Unit_FK="+String.valueOf(Unit_FK));
		sb.append(",Sponsor_FK="+String.valueOf(Sponsor_FK));
		sb.append(",promised_amount_TND="+String.valueOf(promised_amount_TND));
		sb.append(",Received_amount_TND="+String.valueOf(Received_amount_TND));
	    sb.append("]");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_Fact_sponsors.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_Fact_sponsors.length == 0) {
   					commonByteArray_PROJET_PI_BI_Fact_sponsors = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_Fact_sponsors = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_Fact_sponsors, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Fact_sponsors, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_Fact_sponsors, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Fact_sponsors, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wD3XxlGasqbkZPMNgfr0Cd8GF84unnsOwjTfiopfjM5+slPhSvU=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Fact_Sponsors";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Fact_Sponsors";
}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1 + "]([Location_FK] INT  not null ,[Date_FK] INT  not null ,[Unit_FK] INT  not null ,[Sponsor_FK] INT  not null ,[promised_amount_TND] INT ,[Received_amount_TND] INT )");
                                    }
                                }
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Location_FK],[Date_FK],[Unit_FK],[Sponsor_FK],[promised_amount_TND],[Received_amount_TND]) VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:xQdhLk6EWitoCjmdxu+f9YJMZisMZPzgu7cJB0Kw1aSMrX969YQ=");
		    ...
		    String dbquery_tDBInput_1 = "select dbo.sponsor_SA.ID_Sponsor,dbo.sponsor_SA.Code_Sponsor,dbo.sponsor_SA.Nom_Sponsor,dbo.sponsor_SA.Type_Sponsor,dbo"
...
+"tes \nfrom youth_leadership_and_outdoor_education.dbo.sponsor_SA";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.ID_Sponsor = null;
							} else {
		                          
            row1.ID_Sponsor = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    row1.ID_Sponsor = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.Code_Sponsor = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Code_Sponsor = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Code_Sponsor = tmpContent_tDBInput_1;
                }
            } else {
                row1.Code_Sponsor = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.Nom_Sponsor = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(3);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Nom_Sponsor = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Nom_Sponsor = tmpContent_tDBInput_1;
                }
            } else {
                row1.Nom_Sponsor = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.Type_Sponsor = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(4);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Type_Sponsor = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Type_Sponsor = tmpContent_tDBInput_1;
                }
            } else {
                row1.Type_Sponsor = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Secteur = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Secteur = tmpContent_tDBInput_1;
                }
            } else {
                row1.Secteur = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.Theme_Sponsorship = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(6);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Theme_Sponsorship = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Theme_Sponsorship = tmpContent_tDBInput_1;
                }
            } else {
                row1.Theme_Sponsorship = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Saison = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Saison = tmpContent_tDBInput_1;
                }
            } else {
                row1.Saison = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(9).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Date_Engagement = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Date_Engagement = tmpContent_tDBInput_1;
                }
            } else {
                row1.Date_Engagement = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Date_Reception = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Date_Reception = tmpContent_tDBInput_1;
                }
            } else {
                row1.Date_Reception = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.Montant_Promis_TND = null;
							} else {
		                          
            row1.Montant_Promis_TND = rs_tDBInput_1.getInt(11);
            if(rs_tDBInput_1.wasNull()){
                    row1.Montant_Promis_TND = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.Montant_Recu_TND = null;
							} else {
		                          
            row1.Montant_Recu_TND = rs_tDBInput_1.getInt(12);
            if(rs_tDBInput_1.wasNull()){
                    row1.Montant_Recu_TND = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_1 != null) {
                ...
                row1.Statut = null;
							...
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.Affectation_Budgetaire = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(14).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Affectation_Budgetaire = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Affectation_Budgetaire = tmpContent_tDBInput_1;
                }
            } else {
                row1.Affectation_Budgetaire = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(16).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Gouvernorat_Sponsor = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Gouvernorat_Sponsor = tmpContent_tDBInput_1;
                }
            } else {
                row1.Gouvernorat_Sponsor = null;
            }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.Code_lieu = row1.Code_lieu ;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.Code_lieu = '" + row2HashKey.Code_lieu + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.full_date = TalendDate.parseDate("dd/MM/yyyy", row1.Date_Reception) == null ? null : new java.util.Date(TalendDate.parseDate("dd/MM/yyyy", row1.Date_Reception).getTime());
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row4HashKey.unite_name = row1.Unite ;
								  ...
								  if(!tHash_Lookup_row4.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.unite_name = '" + row4HashKey.unite_name + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.sponsor_code = row1.Code_Sponsor ;
								  ...
								  if(!tHash_Lookup_row5.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.sponsor_code = '" + row5HashKey.sponsor_code + "'");
								} // G 071
...
// # Output table : 'out1'
out1_tmp.Location_FK = row2.id_gouvernorat ;
out1_tmp.Date_FK = row3.date_id ;
out1_tmp.Unit_FK = row4.unit_id ;
out1_tmp.Sponsor_FK = row5.sponsor_id ;
out1_tmp.promised_amount_TND = row1.Montant_Promis_TND ;
out1_tmp.Received_amount_TND = row1.Montant_Recu_TND ;
out1 = out1_tmp;
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, out1.Location_FK);

                    pstmt_tDBOutput_1.setInt(2, out1.Date_FK);

                    pstmt_tDBOutput_1.setInt(3, out1.Unit_FK);

                    pstmt_tDBOutput_1.setInt(4, out1.Sponsor_FK);

                    if(out1.promised_amount_TND == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(5, out1.promised_amount_TND);
}

                    if(out1.Received_amount_TND == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(6, out1.Received_amount_TND);
}
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
	...
	public void copyDataTo(row2Struct other) {
		...
		other.Code_lieu = this.Code_lieu;
	            ...
	            other.id_gouvernorat = this.id_gouvernorat;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
			            ...
			            this.id_gouvernorat = dis.readInt();
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.id_gouvernorat = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
		            	...
		            	dos.writeInt(this.id_gouvernorat);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.id_gouvernorat);
    ...
    public String toString() {
		...
		sb.append(",id_gouvernorat="+String.valueOf(id_gouvernorat));
	    sb.append("]");
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:nOFtMtom8HcEqFIhv2VD9lSRhWfxLyAvfGo6+uDg1IpSLduIjYw=");
		    ...
		    String dbquery_tDBInput_2 = "select dbo.dim_location.Code_lieu,dbo.dim_location.Gouvernorat,dbo.dim_location.id_gouvernorat \nfrom scout_DW.dbo.dim_l"
+"ocation";
            ...
            if(tmpContent_tDBInput_2 != null) {
                ...
                row2.Code_lieu = null;
							...
							if(colQtyInRs_tDBInput_2 < 2) {
								row2.Gouvernorat = null;
							} else {
	                         		
           		tmpContent_tDBInput_2 = rs_tDBInput_2.getString(2);
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.Gouvernorat = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.Gouvernorat = tmpContent_tDBInput_2;
                }
            } else {
                row2.Gouvernorat = null;
            }
							...
							if(colQtyInRs_tDBInput_2 < 3) {
								row2.id_gouvernorat = 0;
							} else {
		                          
            row2.id_gouvernorat = rs_tDBInput_2.getInt(3);
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.Code_lieu = row2.Code_lieu;
				
				row2_HashRow.Gouvernorat = row2.Gouvernorat;
				
				row2_HashRow.id_gouvernorat = row2.id_gouvernorat;
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FEwpoIidDeIyTMMFdryLf1mrnpDnKesy/MaUXd82aNM7Y0pw+IM=");
		    ...
		    String dbquery_tDBInput_3 = "select dbo.dim_date.date_id,dbo.dim_date.full_date,dbo.dim_date.jour_nom,dbo.dim_date.mois_nom,dbo.dim_date.annee,dbo.d"
+"im_date.trimestre,dbo.dim_date.saison \nfrom scout_DW.dbo.dim_date";
			...
			row3.full_date = mssqlGTU_tDBInput_3.getDate(rsmd_tDBInput_3, rs_tDBInput_3, 2);
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.jour_nom = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.jour_nom = tmpContent_tDBInput_3;
                }
            } else {
                row3.jour_nom = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.mois_nom = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.mois_nom = tmpContent_tDBInput_3;
                }
            } else {
                row3.mois_nom = null;
            }
            ...
            row3.annee = rs_tDBInput_3.getInt(5);
            if(rs_tDBInput_3.wasNull()){
                    row3.annee = null;
            }
		                    }
            ...
            row3.trimestre = rs_tDBInput_3.getInt(6);
            if(rs_tDBInput_3.wasNull()){
                    row3.trimestre = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.jour_nom = row3.jour_nom;
				
				row3_HashRow.mois_nom = row3.mois_nom;
				
				row3_HashRow.annee = row3.annee;
				
				row3_HashRow.trimestre = row3.trimestre;
				
				row3_HashRow.saison = row3.saison;
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.unite_name == null) ? 0 : this.unite_name.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row4Struct other = (row4Struct) obj;
						...
						if (this.unite_name == null) {
							if (other.unite_name != null)
								return false;
						
						} else if (!this.unite_name.equals(other.unite_name))
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.unit_code = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.unit_code = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.unit_code, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.unit_id);
						...
						writeString(this.unit_code, dos, objectOut);
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.unite_name, other.unite_name);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:IPZbMkZFeagqEzl+ugzhiib7Xo++p3X7g+Bf1/SxygJzW/j99Ao=");
		    ...
		    String dbquery_tDBInput_4 = "select dbo.dim_unite.unit_id,dbo.dim_unite.unite_name,dbo.dim_unite.unit_code,dbo.dim_unite.age_category \nfrom scout_DW"
+".dbo.dim_unite";
            ...
            row4.unit_id = rs_tDBInput_4.getInt(1);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row4.unite_name = null;
							} else {
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.unite_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.unite_name = tmpContent_tDBInput_4;
                }
            } else {
                row4.unite_name = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.unit_code = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.unit_code = tmpContent_tDBInput_4;
                }
            } else {
                row4.unit_code = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.age_category = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.age_category = tmpContent_tDBInput_4;
                }
            } else {
                row4.age_category = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.unit_id = row4.unit_id;
				
				row4_HashRow.unite_name = row4.unite_name;
				
				row4_HashRow.unit_code = row4.unit_code;
				
				row4_HashRow.age_category = row4.age_category;
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
    ...
    public String loopKey;
			    ...
			    public String sponsorship_theme;

				public String getSponsorship_theme () {
					return this.sponsorship_theme;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.sponsor_code == null) ? 0 : this.sponsor_code.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row5Struct other = (row5Struct) obj;
						...
						if (this.sponsor_code == null) {
							if (other.sponsor_code != null)
								return false;
						
						} else if (!this.sponsor_code.equals(other.sponsor_code))
	...
	public void copyDataTo(row5Struct other) {
		...
		other.sponsor_id = this.sponsor_id;
	            other.sponsor_code = this.sponsor_code;
	            other.sponsor_name = this.sponsor_name;
	            other.sponsor_type = this.sponsor_type;
	            other.sector = this.sector;
	            other.sponsorship_theme = this.sponsorship_theme;
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Fact_sponsors) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.sponsor_code = readString(dis);
    ...
    public void writeKeysData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.sponsor_code,dos);
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
			            ...
			            this.sponsor_id = dis.readInt();
					
						this.sponsor_name = readString(dis,ois);
					
						this.sponsor_type = readString(dis,ois);
					
						this.sector = readString(dis,ois);
					
						this.sponsorship_theme = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.sponsor_id = objectIn.readInt();
					
						this.sponsor_name = readString(dis,objectIn);
					
						this.sponsor_type = readString(dis,objectIn);
					
						this.sector = readString(dis,objectIn);
					
						this.sponsorship_theme = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
		            	...
		            	dos.writeInt(this.sponsor_id);
					
						writeString(this.sponsor_name, dos, oos);
					
						writeString(this.sponsor_type, dos, oos);
					
						writeString(this.sector, dos, oos);
					
						writeString(this.sponsorship_theme, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.sponsor_id);
					
						writeString(this.sponsor_name, dos, objectOut);
					
						writeString(this.sponsor_type, dos, objectOut);
					
						writeString(this.sector, dos, objectOut);
					
						writeString(this.sponsorship_theme, dos, objectOut);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("sponsor_id="+String.valueOf(sponsor_id));
		sb.append(",sponsor_code="+sponsor_code);
		sb.append(",sponsor_name="+sponsor_name);
		sb.append(",sponsor_type="+sponsor_type);
		sb.append(",sector="+sector);
		sb.append(",sponsorship_theme="+sponsorship_theme);
	    sb.append("]");
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.sponsor_code, other.sponsor_code);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:g8CpGJVhtkSSz6bubJ4fUHRH6letzanVqZRrXiLRQv9JlszXgYo=");
		    ...
		    String dbquery_tDBInput_5 = "select dbo.dim_sponsor.sponsor_id,dbo.dim_sponsor.sponsor_code,dbo.dim_sponsor.sponsor_name,dbo.dim_sponsor.sponsor_typ"
+"e,dbo.dim_sponsor.sector,dbo.dim_sponsor.sponsorship_theme \nfrom scout_DW.dbo.dim_sponsor";
            ...
            row5.sponsor_id = rs_tDBInput_5.getInt(1);
            if(rs_tDBInput_5.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_5 < 2) {
								row5.sponsor_code = null;
							} else {
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row5.sponsor_code = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row5.sponsor_code = tmpContent_tDBInput_5;
                }
            } else {
                row5.sponsor_code = null;
            }
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row5.sponsor_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row5.sponsor_name = tmpContent_tDBInput_5;
                }
            } else {
                row5.sponsor_name = null;
            }
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row5.sponsor_type = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row5.sponsor_type = tmpContent_tDBInput_5;
                }
            } else {
                row5.sponsor_type = null;
            }
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row5.sector = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row5.sector = tmpContent_tDBInput_5;
                }
            } else {
                row5.sector = null;
            }
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row5.sponsorship_theme = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row5.sponsorship_theme = tmpContent_tDBInput_5;
                }
            } else {
                row5.sponsorship_theme = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
				...
				row5_HashRow.sponsor_id = row5.sponsor_id;
				
				row5_HashRow.sponsor_code = row5.sponsor_code;
				
				row5_HashRow.sponsor_name = row5.sponsor_name;
				
				row5_HashRow.sponsor_type = row5.sponsor_type;
				
				row5_HashRow.sector = row5.sector;
				
				row5_HashRow.sponsorship_theme = row5.sponsorship_theme;
 ...
 */
    ...
    public static void main(String[] args){
        final Fact_sponsors Fact_sponsorsClass = new Fact_sponsors();

        int exitCode = Fact_sponsorsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fact_sponsors.class.getClassLoader().getResourceAsStream("projet_pi_bi/fact_sponsors_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Fact_sponsors.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fact_sponsors");
        }
...
/************************************************************************************************
 *     192735 characters generated by Talend Open Studio for Data Integration 

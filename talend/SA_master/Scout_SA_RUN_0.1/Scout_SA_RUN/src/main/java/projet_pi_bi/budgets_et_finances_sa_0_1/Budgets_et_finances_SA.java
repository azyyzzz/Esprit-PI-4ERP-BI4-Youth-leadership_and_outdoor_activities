...
package projet_pi_bi.budgets_et_finances_sa_0_1;
...
/**
 * Job: Budgets_et_finances_SA Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Budgets_et_finances_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Budgets_et_finances_SA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Budgets_et_finances_SA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Budgets_et_finances_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_Budgets_et_finances_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA = new byte[0];
			    ...
			    public Integer Budget_Alloue;

				public Integer getBudget_Alloue () {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Budgets_et_finances_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Budgets_et_finances_SA) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Code_Saison = readString(dis);
						...
						this.Budget_Alloue = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.Budget_Alloue,dos);
    ...
    public String toString() {
		...
		sb.append(",Budget_Alloue="+String.valueOf(Budget_Alloue));
	    sb.append("]");
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2HW5fvvGHRPVsjRHDo2Ql7g04UPWNaq3GpXEkRZw4wYCmsnkh5M=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Budgets_et_finances_SA";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Budgets_et_finances_SA";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Code_Unite],[Code_Saison],[Budget_Alloue]) VALUES (?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UswzAYbbNhq7DnWN5vz5Tsg4VpciQ76HpFDYTQ==");
		...
		Object source_tFileInputExcel_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/Budgets_et_finances.xlsx";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "FAIT_Budget", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row4.Code_Unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row4.Code_Unite = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row4.Code_Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row4.Code_Saison = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row4.Budget_Alloue = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row4.Budget_Alloue = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row4 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row4.Code_Unite == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row4.Code_Unite);
}

                    if(row4.Code_Saison == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row4.Code_Saison);
}

                    if(row4.Budget_Alloue == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, row4.Budget_Alloue);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Budgets_et_finances_SA Budgets_et_finances_SAClass = new Budgets_et_finances_SA();

        int exitCode = Budgets_et_finances_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Budgets_et_finances_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/budgets_et_finances_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Budgets_et_finances_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Budgets_et_finances_SA");
        }
...
/************************************************************************************************
 *     59662 characters generated by Talend Open Studio for Data Integration 

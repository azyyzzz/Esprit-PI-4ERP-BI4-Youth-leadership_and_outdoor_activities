...
package projet_pi_bi.activites_par_unite_et_saison_sa_0_1;
...
/**
 * Job: Activites_par_unite_et_saison_SA Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Activites_par_unite_et_saison_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Activites_par_unite_et_saison_SA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Activites_par_unite_et_saison_SA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Activites_par_unite_et_saison_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_Activites_par_unite_et_saison_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Activites_par_unite_et_saison_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Activites_par_unite_et_saison_SA) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:CINnWMj494ZLUKNHttB8OW8Bik0UyiEINPRcILwKHwLylJtRRKo=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Activites_par_unite_et_saison_SA";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Activites_par_unite_et_saison_SA";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Unite],[Colonne_Saison],[Valeur],[Code_Saison],[Code_Unite]) VALUES (?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wgj4fqe2BlOhk71qbkRDQgq5q6uAZr+DwFpu/g==");
		...
		Object source_tFileInputExcel_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/Activites_par_unite_et_saison.xlsx";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row2.Unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Unite = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Colonne_Saison";

				row2.Colonne_Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Colonne_Saison = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Valeur";

				row2.Valeur = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Valeur = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row2.Code_Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Code_Saison = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row2.Code_Unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Code_Unite = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
pstmt_tDBOutput_1.setNString(1, row2.Unite);
} else {
pstmt_tDBOutput_1.setString(1, row2.Unite);
}
}

                    if(row2.Colonne_Saison == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row2.Colonne_Saison);
}

                    if(row2.Valeur == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, row2.Valeur);
}

                    if(row2.Code_Saison == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row2.Code_Saison);
}

                    if(row2.Code_Unite == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row2.Code_Unite);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Activites_par_unite_et_saison_SA Activites_par_unite_et_saison_SAClass = new Activites_par_unite_et_saison_SA();

        int exitCode = Activites_par_unite_et_saison_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Activites_par_unite_et_saison_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/activites_par_unite_et_saison_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Activites_par_unite_et_saison_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Activites_par_unite_et_saison_SA");
        }
...
/************************************************************************************************
 *     62167 characters generated by Talend Open Studio for Data Integration 

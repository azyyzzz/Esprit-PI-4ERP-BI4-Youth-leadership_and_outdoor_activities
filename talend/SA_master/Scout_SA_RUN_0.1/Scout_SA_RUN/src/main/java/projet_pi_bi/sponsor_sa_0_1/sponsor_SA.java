...
package projet_pi_bi.sponsor_sa_0_1;
...
/**
 * Job: sponsor_SA Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class sponsor_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "sponsor_SA";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(sponsor_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row14Struct implements routines.system.IPersistableRow<row14Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_sponsor_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_sponsor_SA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_sponsor_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_sponsor_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_sponsor_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_sponsor_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_sponsor_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_sponsor_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_sponsor_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_sponsor_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_sponsor_SA) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:n3rxKUNyTn8Q6x7dehugExgNS6SkZIOuW7Pr6wiTdaylBllS41Y=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "sponsor_SA";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "sponsor_SA";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([ID_Sponsor],[Code_Sponsor],[Nom_Sponsor],[Type_Sponsor],[Secteur],[Theme_Sponsorship],[Unite],[Saison],[Date_Engagement],[Date_Reception],[Montant_Promis_TND],[Montant_Recu_TND],[Statut],[Affectation_Budgetaire],[Code_lieu],[Gouvernorat_Sponsor],[Notes]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:zqTfASiSgiypQ+2lWKXHZ6WIiYpTJapwAS7UVQ==");
		...
		Object source_tFileInputExcel_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/sponsor_v2.xlsx";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "ID_Sponsor";

				row14.ID_Sponsor = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row14.ID_Sponsor = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Code_Sponsor";

				row14.Code_Sponsor = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Code_Sponsor = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Nom_Sponsor";

				row14.Nom_Sponsor = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Nom_Sponsor = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Type_Sponsor";

				row14.Type_Sponsor = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Type_Sponsor = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row14.Secteur = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Secteur = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Theme_Sponsorship";

				row14.Theme_Sponsorship = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Theme_Sponsorship = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Unite";

				row14.Unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Unite = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row14.Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Saison = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Date_Engagement";

				row14.Date_Engagement = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Date_Engagement = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Date_Reception";

				row14.Date_Reception = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Date_Reception = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Montant_Promis_TND";

				row14.Montant_Promis_TND = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row14.Montant_Promis_TND = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Montant_Recu_TND";

				row14.Montant_Recu_TND = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row14.Montant_Recu_TND = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row14.Statut = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Statut = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Affectation_Budgetaire";

				row14.Affectation_Budgetaire = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Affectation_Budgetaire = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Code_lieu";

				row14.Code_lieu = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Code_lieu = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Gouvernorat_Sponsor";

				row14.Gouvernorat_Sponsor = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Gouvernorat_Sponsor = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Notes";

				row14.Notes = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row14.Notes = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row14 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row14.ID_Sponsor == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, row14.ID_Sponsor);
}

                    if(row14.Code_Sponsor == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row14.Code_Sponsor);
}

                    if(row14.Nom_Sponsor == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row14.Nom_Sponsor);
}

                    if(row14.Type_Sponsor == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row14.Type_Sponsor);
}

                    if(row14.Secteur == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row14.Secteur);
}

                    if(row14.Theme_Sponsorship == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, row14.Theme_Sponsorship);
}
...
pstmt_tDBOutput_1.setNString(7, row14.Unite);
} else {
pstmt_tDBOutput_1.setString(7, row14.Unite);
}
}

                    if(row14.Saison == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, row14.Saison);
}

                    if(row14.Date_Engagement == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, row14.Date_Engagement);
}

                    if(row14.Date_Reception == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, row14.Date_Reception);
}

                    if(row14.Montant_Promis_TND == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(11, row14.Montant_Promis_TND);
}

                    if(row14.Montant_Recu_TND == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(12, row14.Montant_Recu_TND);
}

                    if(row14.Statut == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, row14.Statut);
}

                    if(row14.Affectation_Budgetaire == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, row14.Affectation_Budgetaire);
}

                    if(row14.Code_lieu == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, row14.Code_lieu);
}

                    if(row14.Gouvernorat_Sponsor == null) {
pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(16, row14.Gouvernorat_Sponsor);
}

                    if(row14.Notes == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, row14.Notes);
}
 ...
 */
    ...
    public static void main(String[] args){
        final sponsor_SA sponsor_SAClass = new sponsor_SA();

        int exitCode = sponsor_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sponsor_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/sponsor_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sponsor_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sponsor_SA");
        }
...
/************************************************************************************************
 *     74880 characters generated by Talend Open Studio for Data Integration 

...
package projet_pi_bi.membres_par_unite_et_saison_sa_0_1;
...
/**
 * Job: Membres_Par_Unite_Et_Saison_SA Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Membres_Par_Unite_Et_Saison_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Membres_Par_Unite_Et_Saison_SA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Membres_Par_Unite_Et_Saison_SA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Membres_Par_Unite_Et_Saison_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row11Struct implements routines.system.IPersistableRow<row11Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA = new byte[0];
			    ...
			    public Integer Nb_Chefs;

				public Integer getNb_Chefs () {
					return this.Nb_Chefs;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Membres_Par_Unite_Et_Saison_SA) {
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.Nb_Chefs,dos);
    ...
    public String toString() {
		...
		sb.append(",Nb_Chefs="+String.valueOf(Nb_Chefs));
	    sb.append("]");
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ksZx4TuCiapgjS5v7NIramFOnluk1ijmVuTQNquyHo4ajIlysu4=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Membres_Par_Unite_Et_Saison_SA";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Membres_Par_Unite_Et_Saison_SA";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Code_Unite],[Unite],[Code_Saison],[Saison],[Nb_Chefs]) VALUES (?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:AOy5lxLpTf4nX8tKkH0XqnbMCkoEeZfjfWRXtw==");
		...
		Object source_tFileInputExcel_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/Membres_Par_Unite_Et_Saison.xlsx";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "FAIT_Membres", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row11.Code_Unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row11.Code_Unite = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row11.Unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row11.Unite = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row11.Code_Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row11.Code_Saison = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row11.Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row11.Saison = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Nb_Chefs";

				row11.Nb_Chefs = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row11.Nb_Chefs = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row11 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row11.Code_Unite == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row11.Code_Unite);
}
...
pstmt_tDBOutput_1.setNString(2, row11.Unite);
} else {
pstmt_tDBOutput_1.setString(2, row11.Unite);
}
}

                    if(row11.Code_Saison == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row11.Code_Saison);
}

                    if(row11.Saison == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row11.Saison);
}

                    if(row11.Nb_Chefs == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(5, row11.Nb_Chefs);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Membres_Par_Unite_Et_Saison_SA Membres_Par_Unite_Et_Saison_SAClass = new Membres_Par_Unite_Et_Saison_SA();

        int exitCode = Membres_Par_Unite_Et_Saison_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Membres_Par_Unite_Et_Saison_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/membres_par_unite_et_saison_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Membres_Par_Unite_Et_Saison_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Membres_Par_Unite_Et_Saison_SA");
        }
...
/************************************************************************************************
 *     61966 characters generated by Talend Open Studio for Data Integration 
 *     on the 28 février 2026 à 18:01:26 WAT
 ************************************************************************************************/
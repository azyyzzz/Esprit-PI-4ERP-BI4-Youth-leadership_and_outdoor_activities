...
package projet_pi_bi.scout_evolution_saison_sa_0_1;
...
/**
 * Job: Scout_Evolution_Saison_SA Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Scout_Evolution_Saison_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Scout_Evolution_Saison_SA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Scout_Evolution_Saison_SA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Scout_Evolution_Saison_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_Scout_Evolution_Saison_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Scout_Evolution_Saison_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Scout_Evolution_Saison_SA) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5SQ/hZzn1psQ46J9Ii598Vf9kyyKLEQg9Ad6kU7FOpw19BJ+vAY=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Scout_Evolution_Saison_SA";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Scout_Evolution_Saison_SA";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([unite],[Tranche_age],[Nb_Membres],[Annee],[Code_Unite]) VALUES (?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:PkgHmQlmi7zvTK62jfeTxvpKngNpa3GZOoJVwA==");
		...
		Object source_tFileInputExcel_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/Scout_Evolution_Saison.xlsx";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "FAIT_Evolution", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row12.unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row12.unite = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Tranche_age";

				row12.Tranche_age = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row12.Tranche_age = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Nb_Membres";

				row12.Nb_Membres = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row12.Nb_Membres = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row12.Annee = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row12.Annee = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row12.Code_Unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row12.Code_Unite = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
pstmt_tDBOutput_1.setNString(1, row12.unite);
} else {
pstmt_tDBOutput_1.setString(1, row12.unite);
}
}

                    if(row12.Tranche_age == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row12.Tranche_age);
}

                    if(row12.Nb_Membres == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, row12.Nb_Membres);
}

                    if(row12.Annee == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(4, row12.Annee);
}

                    if(row12.Code_Unite == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row12.Code_Unite);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Scout_Evolution_Saison_SA Scout_Evolution_Saison_SAClass = new Scout_Evolution_Saison_SA();

        int exitCode = Scout_Evolution_Saison_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Scout_Evolution_Saison_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/scout_evolution_saison_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Scout_Evolution_Saison_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Scout_Evolution_Saison_SA");
        }
...
/************************************************************************************************
 *     61979 characters generated by Talend Open Studio for Data Integration 

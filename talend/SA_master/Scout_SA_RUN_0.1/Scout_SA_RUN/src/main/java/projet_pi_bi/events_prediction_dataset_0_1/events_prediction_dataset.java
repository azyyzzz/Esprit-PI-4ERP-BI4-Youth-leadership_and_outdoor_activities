...
package projet_pi_bi.events_prediction_dataset_0_1;
...
/**
 * Job: events_prediction_dataset Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class events_prediction_dataset implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "events_prediction_dataset";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				events_prediction_dataset.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(events_prediction_dataset.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_events_prediction_dataset = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_events_prediction_dataset = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_events_prediction_dataset.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_events_prediction_dataset.length == 0) {
   					commonByteArray_PROJET_PI_BI_events_prediction_dataset = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_events_prediction_dataset = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_events_prediction_dataset, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_events_prediction_dataset, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_events_prediction_dataset, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_events_prediction_dataset, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_events_prediction_dataset) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:6FPNMUC63ioS2Zqg0vTV6Ne51gZmnADfWFN+kPfVO1LYNoGc9a8=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "events_prediction_dataset";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "events_prediction_dataset";
}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1 + "]([event_id] VARCHAR(30)  ,[event] VARCHAR(25)  ,[Code_lieu] VARCHAR(4)  ,[location] VARCHAR(32)  ,[lat] VARCHAR(11)  ,[lon] VARCHAR(12)  ,[month] INT ,[season] VARCHAR(6)  ,[event_duration_days] INT ,[temp_max_mean] VARCHAR(17)  ,[rain_total] VARCHAR(4)  ,[wind_max] VARCHAR(4)  ,[weather_score] INT ,[good_weather] BIT ,[date_code] VARCHAR(28)  )");
                                }
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([event_id],[event],[Code_lieu],[location],[lat],[lon],[month],[season],[event_duration_days],[temp_max_mean],[rain_total],[wind_max],[weather_score],[good_weather],[date_code]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:a6oeYCEmGwIAzCOAdOnYxFNZhHydqr0AX38ZZg==");
		...
		Object source_tFileInputExcel_2 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/events_prediction_dataset.xlsx";
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				curColName_tFileInputExcel_2 = "event_id";

				row1.event_id = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.event_id = null;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "event";

				row1.event = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.event = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Code_lieu";

				row1.Code_lieu = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.Code_lieu = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "location";

				row1.location = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.location = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "lat";

				row1.lat = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.lat = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "lon";

				row1.lon = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.lon = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row1.month = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], null, '.'==decimalChar_tFileInputExcel_2 ? null : decimalChar_tFileInputExcel_2));
			}else{
				row1.month = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "season";

				row1.season = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.season = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "event_duration_days";

				row1.event_duration_days = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], null, '.'==decimalChar_tFileInputExcel_2 ? null : decimalChar_tFileInputExcel_2));
			}else{
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "temp_max_mean";

				row1.temp_max_mean = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rain_total";

				row1.rain_total = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "wind_max";

				row1.wind_max = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.wind_max = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "weather_score";

				row1.weather_score = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], null, '.'==decimalChar_tFileInputExcel_2 ? null : decimalChar_tFileInputExcel_2));
			}else{
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "good_weather";

				row1.good_weather = ParserUtils.parseTo_Boolean(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2]);
			}else{
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "date_code";

				row1.date_code = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.date_code = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
...
if(row1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row1.event_id == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row1.event_id);
}

                    if(row1.event == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.event);
}

                    if(row1.Code_lieu == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row1.Code_lieu);
}

                    if(row1.location == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row1.location);
}

                    if(row1.lat == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row1.lat);
}

                    if(row1.lon == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, row1.lon);
}

                    if(row1.month == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(7, row1.month);
}

                    if(row1.season == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, row1.season);
}

                    if(row1.event_duration_days == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(9, row1.event_duration_days);
}

                    if(row1.temp_max_mean == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, row1.temp_max_mean);
}

                    if(row1.rain_total == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, row1.rain_total);
}

                    if(row1.wind_max == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, row1.wind_max);
}

                    if(row1.weather_score == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(13, row1.weather_score);
}

                    if(row1.good_weather == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_1.setBoolean(14, row1.good_weather);
}

                    if(row1.date_code == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, row1.date_code);
}
 ...
 */
    ...
    public static void main(String[] args){
        final events_prediction_dataset events_prediction_datasetClass = new events_prediction_dataset();

        int exitCode = events_prediction_datasetClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = events_prediction_dataset.class.getClassLoader().getResourceAsStream("projet_pi_bi/events_prediction_dataset_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = events_prediction_dataset.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : events_prediction_dataset");
        }
...
/************************************************************************************************
 *     73894 characters generated by Talend Open Studio for Data Integration 

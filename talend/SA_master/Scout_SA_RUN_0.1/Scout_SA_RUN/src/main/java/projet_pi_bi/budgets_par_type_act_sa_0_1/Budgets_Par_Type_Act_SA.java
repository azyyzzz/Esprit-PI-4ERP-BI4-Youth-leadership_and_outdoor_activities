...
package projet_pi_bi.budgets_par_type_act_sa_0_1;
...
/**
 * Job: Budgets_Par_Type_Act_SA Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Budgets_Par_Type_Act_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Budgets_Par_Type_Act_SA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Budgets_Par_Type_Act_SA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Budgets_Par_Type_Act_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_Budgets_Par_Type_Act_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA = new byte[0];
			    ...
			    public String Budget_Alloue;

				public String getBudget_Alloue () {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Budgets_Par_Type_Act_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Budgets_Par_Type_Act_SA) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Budget_Alloue = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Budget_Alloue,dos);
    ...
    public String toString() {
		...
		sb.append(",Budget_Alloue="+Budget_Alloue);
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:yhfeYNKAK19Gr3F9nBXc6yakOQsVShIhqREOqwSTuzcZnu0ERTI=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Budgets_Par_Type_Act_SA";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Budgets_Par_Type_Act_SA";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Type_d_Activite],[Colonne_Saison],[Budget_Alloue],[Code_Saison]) VALUES (?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0CB8MjbI7KMsc2rHnIruaEeFpvZBx/rMN56Nfw==");
		...
		Object source_tFileInputExcel_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/Budgets_Par_Type_Act.xlsx";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "FAIT_Budget_Type", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "Type_d_Activite";

				row5.Type_d_Activite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.Type_d_Activite = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.Colonne_Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.Colonne_Saison = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Budget_Alloue";

				row5.Budget_Alloue = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.Budget_Alloue = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.Code_Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.Code_Saison = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row5 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row5.Type_d_Activite == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row5.Type_d_Activite);
}

                    if(row5.Colonne_Saison == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row5.Colonne_Saison);
}

                    if(row5.Budget_Alloue == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row5.Budget_Alloue);
}

                    if(row5.Code_Saison == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row5.Code_Saison);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Budgets_Par_Type_Act_SA Budgets_Par_Type_Act_SAClass = new Budgets_Par_Type_Act_SA();

        int exitCode = Budgets_Par_Type_Act_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Budgets_Par_Type_Act_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/budgets_par_type_act_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Budgets_Par_Type_Act_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Budgets_Par_Type_Act_SA");
        }
...
/************************************************************************************************
 *     59666 characters generated by Talend Open Studio for Data Integration 

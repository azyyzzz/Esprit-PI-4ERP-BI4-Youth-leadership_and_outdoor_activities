...
package projet_pi_bi.scouts_repartition_geographique_sa_0_1;
...
/**
 * Job: scouts_repartition_geographique_SA Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class scouts_repartition_geographique_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "scouts_repartition_geographique_SA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				scouts_repartition_geographique_SA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(scouts_repartition_geographique_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row13Struct implements routines.system.IPersistableRow<row13Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_scouts_repartition_geographique_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_scouts_repartition_geographique_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_scouts_repartition_geographique_SA) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:cazca5poV1hMv/YsWxRNTrhkVXO/vZVeCBVpkf4yD877s69Cybg=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "scouts_repartition_geographique_SA";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "scouts_repartition_geographique_SA";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Code_lieu],[Gouvernorat],[Nombre]) VALUES (?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:1fDyQzKKVMTjafQ4lJd+4kVdA5ANbQxCAJkgmQ==");
		...
		Object source_tFileInputExcel_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/scouts_repartition_geographique.xlsx";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Par Gouvernorat", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row13.Code_lieu = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row13.Code_lieu = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row13.Gouvernorat = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row13.Gouvernorat = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Nombre";

				row13.Nombre = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row13.Nombre = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row13 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row13.Code_lieu == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row13.Code_lieu);
}

                    if(row13.Gouvernorat == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {String driver = null;
driver = "MSSQL_PROP";
if ("MSSQL_PROP".equals(driver)) {
pstmt_tDBOutput_1.setNString(2, row13.Gouvernorat);
} else {
pstmt_tDBOutput_1.setString(2, row13.Gouvernorat);
}
}

                    if(row13.Nombre == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, row13.Nombre);
}
 ...
 */
    ...
    public static void main(String[] args){
        final scouts_repartition_geographique_SA scouts_repartition_geographique_SAClass = new scouts_repartition_geographique_SA();

        int exitCode = scouts_repartition_geographique_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = scouts_repartition_geographique_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/scouts_repartition_geographique_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = scouts_repartition_geographique_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : scouts_repartition_geographique_SA");
        }
...
/************************************************************************************************
 *     60134 characters generated by Talend Open Studio for Data Integration 

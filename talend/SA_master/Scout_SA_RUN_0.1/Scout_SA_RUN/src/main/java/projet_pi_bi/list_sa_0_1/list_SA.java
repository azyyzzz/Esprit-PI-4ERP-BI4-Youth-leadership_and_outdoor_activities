...
package projet_pi_bi.list_sa_0_1;
...
/**
 * Job: list_SA Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class list_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "list_SA";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(list_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_list_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_list_SA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_list_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_list_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_list_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_list_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_list_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_list_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_list_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_list_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_list_SA) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.BirthPlaceCode = readString(dis);
					
					this.Phone = readString(dis);
					
					this.BirthDate = readString(dis);
					
					this.TrainingLevel = readString(dis);
					
					this.Rank = readString(dis);
					
					this.MemberType = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.BirthPlaceCode,dos);
					...
					// String
						...
						writeString(this.TrainingLevel,dos);
					...
					// String
						...
						writeString(this.MemberType,dos);
    ...
    public String toString() {
		...
		sb.append(",BirthPlaceCode="+BirthPlaceCode);
		sb.append(",Phone="+Phone);
		sb.append(",BirthDate="+BirthDate);
		sb.append(",TrainingLevel="+TrainingLevel);
		sb.append(",Rank="+Rank);
...
out1Struct out1 = new out1Struct();
  ...
  String directory_tFileList_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/قائمة الوحدات الخاصة بالفوج20252026";
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7qb6drgDsfIioryOjDsXE2z7U8lYJ4ZfteciSfeMeQXypns6MNk=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "list_sa";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "list_sa";
}
	int count_tDBOutput_1=0;

        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Code_unite],[المعرف],[الإسم],[اللقب],[ب.ت.و],[الهاتف],[تاريخ الولادة],[المستوى التدريبي],[الرتبة],[إطار الوحدة||مشارك]) VALUES (?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Jgt4vuWwX2SCxfHia8TbBaP+Wlr0Qv6LscDgSg==");
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.code_unite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Column1 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Column1 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Column2";

				row1.Column2 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Column2 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Column3";

				row1.Column3 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Column3 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Column4 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Column4 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Column5 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Column5 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Column6 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Column6 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Column7 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Column7 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Column8 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Column8 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
Var.var1 = row1.Column8 != null && (row1.Column8.contains("فاقد الوحدة") || row1.Column8.contains("مساعدة") || row1.Column8.contains("ملازم قائد الوحدة")) ? "إطار الوحدة" : "المشاركون" ;// ###############################
        // ###############################
        // # Output tables
...
// # Output table : 'out1'
out1_tmp.Code_unite = row1.code_unite ;
out1_tmp.ID = row1.Column1 ;
out1_tmp.FirstName = row1.Column2 ;
out1_tmp.LastName = row1.Column3 ;
out1_tmp.BirthPlaceCode = row1.Column4 ;
out1_tmp.Phone = row1.Column5 ;
out1_tmp.BirthDate = row1.Column6 ;
out1_tmp.TrainingLevel = row1.Column7 ;
out1_tmp.Rank = row1.Column8 ;
out1_tmp.MemberType =  Var.var1 ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(out1.Code_unite == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, out1.Code_unite);
}

                    if(out1.ID == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, out1.ID);
}
...
pstmt_tDBOutput_1.setNString(3, out1.FirstName);
} else {
pstmt_tDBOutput_1.setString(3, out1.FirstName);
}
}
...
driver = "MSSQL_PROP";
if ("MSSQL_PROP".equals(driver)) {
pstmt_tDBOutput_1.setNString(4, out1.LastName);
} else {
pstmt_tDBOutput_1.setString(4, out1.LastName);
}
}

                    if(out1.BirthPlaceCode == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, out1.BirthPlaceCode);
}

                    if(out1.Phone == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, out1.Phone);
}

                    if(out1.BirthDate == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, out1.BirthDate);
}

                    if(out1.TrainingLevel == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {String driver = null;
driver = "MSSQL_PROP";
if ("MSSQL_PROP".equals(driver)) {
pstmt_tDBOutput_1.setNString(8, out1.TrainingLevel);
} else {
pstmt_tDBOutput_1.setString(8, out1.TrainingLevel);
}
}
...
driver = "MSSQL_PROP";
if ("MSSQL_PROP".equals(driver)) {
pstmt_tDBOutput_1.setNString(9, out1.Rank);
} else {
pstmt_tDBOutput_1.setString(9, out1.Rank);
}
}

                    if(out1.MemberType == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {String driver = null;
driver = "MSSQL_PROP";
if ("MSSQL_PROP".equals(driver)) {
pstmt_tDBOutput_1.setNString(10, out1.MemberType);
} else {
pstmt_tDBOutput_1.setString(10, out1.MemberType);
}
}
...
public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_1 = false;
		    ...
		    String dbname_tDBRow_1 = "youth_leadership_and_outdoor_education" ;
		    		    
		    String url_tDBRow_1 = "jdbc:sqlserver://" + "192.168.1.18" ;
		    ...
		    if (!"".equals(dbname_tDBRow_1)) {
		    	...
		    	url_tDBRow_1 += ";databaseName=" + "youth_leadership_and_outdoor_education"; 
	...
	final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:znQsrjQI051nMNrPLjp77812r34xbe6azr1uzqOQFGrRglgjVeI=");
...
query_tDBRow_1 = "DELETE FROM [dbo].[list_sa]";
 ...
 */
    ...
    public static void main(String[] args){
        final list_SA list_SAClass = new list_SA();

        int exitCode = list_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = list_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/list_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = list_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : list_SA");
        }
...
/************************************************************************************************
 *     94489 characters generated by Talend Open Studio for Data Integration 

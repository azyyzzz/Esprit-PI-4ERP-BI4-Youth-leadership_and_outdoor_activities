...
package projet_pi_bi.activites_generales_sa_0_1;
...
/**
 * Job: Activites_Generales_SA Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Activites_Generales_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Activites_Generales_SA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Activites_Generales_SA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Activites_Generales_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_Activites_Generales_SA = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_Activites_Generales_SA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_PI_BI_Activites_Generales_SA.length) {
				if(length < 1024 && commonByteArray_PROJET_PI_BI_Activites_Generales_SA.length == 0) {
   					commonByteArray_PROJET_PI_BI_Activites_Generales_SA = new byte[1024];
				} else {
   					commonByteArray_PROJET_PI_BI_Activites_Generales_SA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_PI_BI_Activites_Generales_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Activites_Generales_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJET_PI_BI_Activites_Generales_SA, 0, length);
			strReturn = new String(commonByteArray_PROJET_PI_BI_Activites_Generales_SA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Activites_Generales_SA) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wEYA9Z1AxW27FaXe0trqkH9jI3G6EuZiyo9egQJa2xJ4fbDhXHk=");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Activites_Generales_SA";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Activites_Generales_SA";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Code_type],[Type_d_Activite],[Colonne_Saison],[Valeur],[Code_Saison]) VALUES (?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:PQ7+aFj1QagrZ3bKD/AznJ1+h9hmObc9Gum6Ig==");
		...
		Object source_tFileInputExcel_1 = "C:/Projet_PI_BI/Youth Leadership & Outdoor Education/Scouts/Activites_Generales.xlsx";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "FAIT_Activites_Generales", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Type_d_Activite = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Colonne_Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Valeur = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Valeur = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Code_Saison = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
...
} else {pstmt_tDBOutput_1.setString(1, row1.Code_type);
}

                    if(row1.Type_d_Activite == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.Type_d_Activite);
}

                    if(row1.Colonne_Saison == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row1.Colonne_Saison);
}

                    if(row1.Valeur == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row1.Valeur);
}

                    if(row1.Code_Saison == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row1.Code_Saison);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Activites_Generales_SA Activites_Generales_SAClass = new Activites_Generales_SA();

        int exitCode = Activites_Generales_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Activites_Generales_SA.class.getClassLoader().getResourceAsStream("projet_pi_bi/activites_generales_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Activites_Generales_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Activites_Generales_SA");
        }
...
/************************************************************************************************
 *     60571 characters generated by Talend Open Studio for Data Integration 
 *     on the 28 février 2026 à 18:01:24 WAT
 ************************************************************************************************/
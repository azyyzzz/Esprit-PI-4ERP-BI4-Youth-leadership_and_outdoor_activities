...
package projet_pi_bi.scout_dw_run_methode2_0_1;
...
/**
 * Job: Scout_DW_RUN_methode2 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Scout_DW_RUN_methode2 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Scout_DW_RUN_methode2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Scout_DW_RUN_methode2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Scout_DW_RUN_methode2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PROJET_PI_BI_Scout_DW_RUN_methode2 = new byte[0];
    static byte[] commonByteArray_PROJET_PI_BI_Scout_DW_RUN_methode2 = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_PI_BI_Scout_DW_RUN_methode2) {
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		projet_pi_bi.dim_date_methode2_0_1.dim_date_methode2 childJob_tRunJob_6 = new projet_pi_bi.dim_date_methode2_0_1.dim_date_methode2();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		projet_pi_bi.dim_event_methode2_0_1.dim_event_methode2 childJob_tRunJob_1 = new projet_pi_bi.dim_event_methode2_0_1.dim_event_methode2();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		projet_pi_bi.dim_location_methode2_0_1.dim_location_methode2 childJob_tRunJob_2 = new projet_pi_bi.dim_location_methode2_0_1.dim_location_methode2();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		projet_pi_bi.dim_membre_methode2_0_1.dim_membre_methode2 childJob_tRunJob_3 = new projet_pi_bi.dim_membre_methode2_0_1.dim_membre_methode2();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		projet_pi_bi.dim_sponsor_methode2_0_1.dim_sponsor_methode2 childJob_tRunJob_4 = new projet_pi_bi.dim_sponsor_methode2_0_1.dim_sponsor_methode2();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		projet_pi_bi.dim_unite_methode2_0_1.dim_unite_methode2 childJob_tRunJob_5 = new projet_pi_bi.dim_unite_methode2_0_1.dim_unite_methode2();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Scout_DW_RUN_methode2 Scout_DW_RUN_methode2Class = new Scout_DW_RUN_methode2();

        int exitCode = Scout_DW_RUN_methode2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Scout_DW_RUN_methode2.class.getClassLoader().getResourceAsStream("projet_pi_bi/scout_dw_run_methode2_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Scout_DW_RUN_methode2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Scout_DW_RUN_methode2");
        }
...
/************************************************************************************************
 *     68379 characters generated by Talend Open Studio for Data Integration 

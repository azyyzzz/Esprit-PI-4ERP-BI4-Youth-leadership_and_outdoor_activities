...
def build_dashboard_knowledge_base():
    return [
        ...
        "The dashboard header shows whether scouts_DW is connected or Excel fallback is used. KPI cards show Data Source DW ML Models count twelve DSS Objectives thirteen per specification and Current Objective number when you click the sidebar.",
...
def api_chatbot():
    ...
    if conf < 0.12:
        answer = (
            ...
            "“What is CHFA membership forecast?”, or “Is scouts_DW connected?”. "
